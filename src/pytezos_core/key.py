...
from pytezos_core.encoding import base58_decode
from pytezos_core.encoding import base58_encode
from pytezos_core.encoding import scrub_input
...
class CryptoExtraFallback:
    ...
    def __getattr__(self, item: Any) -> NoReturn:
        raise ImportError(
            "Please, install system packages libsodium-dev, libsecp256k1-dev, and libgmp-dev, "
...
try:
    ...
    pysodium = CryptoExtraFallback(e)
    secp256k1 = CryptoExtraFallback(e)
    fastecdsa = CryptoExtraFallback(e)
    bytes_to_int = CryptoExtraFallback(e)
    __crypto__ = False
else:
    __crypto__ = True
